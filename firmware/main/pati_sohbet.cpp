...
void olayi_isle(const ConversationEvent& olay)
{
    ...
    case ConversationEventType::ToolCallRequested:
        // (arac cagrisinda `uyku` alani da okunuyor — asagida)
...
void mik_gorevi(void* /*arg*/)
{
    ...
    while (g_calisiyor) {
        ...
        // ⚠️ BURADA SESSIZLIK BASTIRMA + TUR KAPATMA VARDI, GERI ALINDI.
        //
        // 05.09.2026: Pati cevap vermeyince "sunucu sessizlik goremiyor,
        // turu biz kapatalim" diye eklendi — mikrofon sessizken parcayi
        // sifirliyor, hangover dolunca commit_audio() cagiriyordu.
        //
        // Sonra asil sebep cikti: Live API KOTASI doluydu (TESHIS.md).
        // Yani bu ekleme var olmayan bir sorunu cozuyordu ve DOGRULANAMADI
        // — olcum yapilan her an kota da doluydu. Pati bir gun oncesine
        // kadar bunlarsiz konusuyordu.
        //
        // Doğrulanmamis bir davranis degisikligini uzerinde birakmak,
        // yarin kota acildiginda "acaba bu mu bozdu" sorusunu da beraber
        // getirirdi. Gerekirse geri gelir; o zaman kota acikken olculur.
